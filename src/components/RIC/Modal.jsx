      ...
      {outfit === undefined
        ? (
          <div className="relative flex flex-col rounded-lg self-center bg-gradient-to-r from-violet-600/95 to-gray-400/95 shadow-2xl text-black h-80 w-fit">
            <div className="h-1/6 grid grid-rows-1 grid-cols-3 border-b border-black bg-pastelBlack rounded-t-lg text-white">
              <div data-testid="related-name" className="grid col-start-1 col-span-1 row-start-1 text-center content-center pl-1">
                {relatedItem.name}
              </div>
            ...
            <div data-testid="comparison" className="grid h-5/6 overflow-x-auto bg-[#EDF1FF] shadow-inner">
              {prodFeatures.map((obj) => (
                <div key={obj.feature} className="grid grid-rows-1 grid-cols-3 content-center h-12 border-b">
                  <div data-testid="product-feature" className="grid col-start-1 col-span-1 row-start-1 text-center content-center pl-1">
              ...
              {relatedItem.features.map((obj) => (
                ...
                && (
                  <div key={obj.feature} className="grid grid-rows-1 grid-cols-3 content-center h-12 border-b">
                    <div className="grid col-start-1 col-span-1 row-start-1 text-center justify-center content-center pl-1">
                      { featureValue(obj.value) }
                    </div>
                    <div className="grid col-start-2 col-span-1 row-start-1 text-center content-center">
                      {obj.feature}
