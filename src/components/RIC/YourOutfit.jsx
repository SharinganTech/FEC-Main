  ...
  return (
    <div className="flex overflow-hidden h-[28rem]">
      ...
      <div className="relative flex flex-row space-x-5 w-full h-64">
        ...
        <div
          role="button"
          className="bg-[#EFE1CE] grid rounded-lg shadow-xl hover:shadow-indigo-500/40 h-96 w-48 content-center text-center text-3xl text-[#798EA4] border border-[#798EA4] border-dashed"
          onClick={() => {
        ...
        <div className="flex h-[28rem] w-24 z-50 bg-gradient-to-r from-[#EDF1FF] to-transparent z-0">
          <FontAwesomeIcon icon={faArrowLeft} className="self-center ml-5" />
        </div>
